...
class UnifiedModel(nn.Module):
    def __init__(self, base_model_name):
        ...
        # Use QLoRA config for different tasks
        task1_qlora_config = QLoraConfig(
            task_type="SEQ_CLS",
            r=4,
            lora_alpha=32,
            lora_dropout=0.01,
            target_modules=['query', 'value'],
            bits=4  # Enable 4-bit quantization for memory efficiency
        )

        task2_qlora_config = QLoraConfig(
            task_type="SEQ_CLS",
            r=4,
            lora_alpha=32,
            lora_dropout=0.01,
        ...
        task3_qlora_config = QLoraConfig(
        ...
        self.base_model.add_adapter(task1_qlora_config, adapter_name="adapter_task1")
        self.base_model.add_adapter(task2_qlora_config, adapter_name="adapter_task2")
        self.base_model.add_adapter(task3_qlora_config, adapter_name="adapter_task3")
